...
station_load_train(struct station *station, int count)
{
	...
	printf("train arrives (count: %d)->", count); print_station(station); //In ra thong bao tau den ga voi bao nhieu ghe trong
...
station_wait_for_train(struct station *station)
{
	...
	printf("passenger arrived ->"); print_station(station);//In ra thong bao khach da den ga
	...
	printf("passenger boarding ->"); print_station(station);//In ra thong bao khach dang len tau
	lock_release(station->lck);
}
...
station_on_board(struct station *station)
{
	...
	printf("passenger on board"); print_station(station);//In ra thong bao khach da tren tau ( Tuc la khach da ngoi xuong ghe trong)
